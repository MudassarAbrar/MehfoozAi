...
export const SeatedPhoneWomanArt: React.FC<{ className?: string }> = ({ className = 'w-64 h-64' }) => {
  return (
    ...
    >
      ...
      {/* 1. Large Soft Lilac Background Circle */}
      <circle cx="160" cy="140" r="95" fill="#F3E8FF" />
      
      {/* 2. Top Right Small Decorative Accent Dot */}
      <circle cx="240" cy="80" r="4" fill="#C084FC" />
      <circle cx="85" cy="180" r="3" fill="#C084FC" />

      {/* 3. Location Pin Marker Inside Lilac Sun */}
      <g transform="translate(115, 80)">
        ...
        />
        <circle cx="20" cy="20" r="6" fill="#F3E8FF" stroke="#181A20" strokeWidth="2" />
      </g>

      {/* 4. Three Stacked Pillows / Cushions (Matching Reference Illustration) */}
      {/* Top Cushion (Light Lilac Tint) */}
      <g transform="translate(45, 175)">
        <path
          ...
          strokeLinejoin="round"
        />
        <circle cx="10" cy="25" r="2.5" fill="#181A20" />
        <circle cx="220" cy="25" r="2.5" fill="#181A20" />
      </g>

      {/* Middle Cushion (Pastel Violet / Lilac) */}
      <g transform="translate(40, 200)">
        ...
        />
        <circle cx="10" cy="25" r="2.5" fill="#181A20" />
        <circle cx="230" cy="25" r="2.5" fill="#181A20" />
      </g>
      ...
      <g transform="translate(42, 230)">
        ...
        />
        <circle cx="10" cy="25" r="2.5" fill="#181A20" />
        <circle cx="225" cy="25" r="2.5" fill="#181A20" />
      </g>

      {/* 5. Seated Figure in Clean Modern Minimalist Line Art */}
      <g transform="translate(90, 85)">
        {/* Head with Short Stylized Hair */}
        <circle cx="130" cy="20" r="14" fill="#FFFFFF" stroke="#181A20" strokeWidth="2.5" />
        {/* Hair shape */}
        <path
        ...
        {/* Neck */}
        <path d="M126 34 L126 40" stroke="#181A20" strokeWidth="2.5" strokeLinecap="round" />

        {/* Torso / Top (Purple Accent Vest) */}
        <path
  ...
  return (
    <svg viewBox="0 0 280 90" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      ...
      <path
        ...
        opacity="0.4"
      />
      <circle cx="95" cy="18" r="2" fill="#181A20" opacity="0.5" />
      <circle cx="210" cy="35" r="2" fill="#181A20" opacity="0.5" />

      {/* Hanging Wire for Lamp */}
      <path d="M225 0 L225 35" stroke="#181A20" strokeWidth="1.5" />
      <circle cx="225" cy="35" r="3" fill="#181A20" />
      ...
      <ellipse cx="225" cy="61" rx="14" ry="4" fill="#FFFFFF" />
      <circle cx="225" cy="62" r="3" fill="#B886FD" />
    </svg>
  );
};
