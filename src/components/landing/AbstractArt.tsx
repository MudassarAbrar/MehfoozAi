    ...
    <div className={`relative overflow-hidden ${className}`}>
      ...
      >
        ...
        <motion.path
          ...
          fill="url(#absGradLilac2)"
        />

        {/* Geometric Isometric Floating Shield Ring */}
        <motion.g
        ...
        {/* Floating Glowing Sphere Nodes */}
        <motion.circle
          cx="260"
          cy="220"
          r="16"
          fill="url(#absGradSoft)"
