...
export const LAHORE_LOCATIONS: LahoreLocation[] = [
  ...
  { id: 'barkat-market', name: 'Barkat Market New Garden Town', nameUrdu: 'برکت مارکیٹ گارڈن ٹاؤن', lat: 31.5030, lng: 74.3290, district: 'Lahore', type: 'commercial', safetyScore: 89, wellLitPercent: 91, cctvPercent: 84, policeNearby: true, activeWomenCount: 8, safeZonesCount: 4 },
  { id: 'shadman', name: 'Shadman Market & Underpass', nameUrdu: 'شادمان مارکیٹ', lat: 31.5420, lng: 74.3310, district: 'Lahore', type: 'residential', safetyScore: 87, wellLitPercent: 85, cctvPercent: 79, policeNearby: true, activeWomenCount: 6, safeZonesCount: 3 },
  { id: 'jail-road', name: 'Jail Road Services Corridor', nameUrdu: 'جیل روڈ سروسز کوریڈور', lat: 31.5380, lng: 74.3490, district: 'Lahore', type: 'landmark', safetyScore: 92, wellLitPercent: 94, cctvPercent: 88, policeNearby: true, activeWomenCount: 9, safeZonesCount: 5 },
  { id: 'ferozepur-road', name: 'Ferozepur Road Metro Corridor', nameUrdu: 'فیروز پور روڈ میٹرو کوریڈور', lat: 31.5180, lng: 74.3410, district: 'Lahore', type: 'transit', safetyScore: 88, wellLitPercent: 89, cctvPercent: 83, policeNearby: true, activeWomenCount: 7, safeZonesCount: 4 },
  { id: 'askari-10', name: 'Askari 10 Cantt', nameUrdu: 'عسکری 10 کینٹ', lat: 31.5290, lng: 74.4020, district: 'Lahore', type: 'residential', safetyScore: 96, wellLitPercent: 97, cctvPercent: 94, policeNearby: true, activeWomenCount: 5, safeZonesCount: 5 },
  { id: 'township', name: 'Township Main Bazaar', nameUrdu: 'ٹاؤن شپ مین بازار', lat: 31.4510, lng: 74.3120, district: 'Lahore', type: 'commercial', safetyScore: 81, wellLitPercent: 78, cctvPercent: 66, policeNearby: true, activeWomenCount: 6, safeZonesCount: 2 },
  { id: 'lums-dha3', name: 'LUMS / DHA Phase 3 Hub', nameUrdu: 'لمز / ڈی ایچ اے فیز 3', lat: 31.4720, lng: 74.4090, district: 'Lahore', type: 'educational', safetyScore: 95, wellLitPercent: 96, cctvPercent: 91, policeNearby: true, activeWomenCount: 10, safeZonesCount: 5 },
  { id: 'ichhra', name: 'Ichhra Bazaar Ferozepur', nameUrdu: 'اچھڑہ بازار', lat: 31.5310, lng: 74.3270, district: 'Lahore', type: 'commercial', safetyScore: 79, wellLitPercent: 74, cctvPercent: 62, policeNearby: true, activeWomenCount: 8, safeZonesCount: 2 },
  { id: 'samanabad', name: 'Samanabad Main Roundabout', nameUrdu: 'سمن آباد مین چوک', lat: 31.5360, lng: 74.3010, district: 'Lahore', type: 'residential', safetyScore: 84, wellLitPercent: 81, cctvPercent: 70, policeNearby: true, activeWomenCount: 5, safeZonesCount: 3 },
  { id: 'cavalry-ground', name: 'Cavalry Ground Commercial', nameUrdu: 'کیولری گراؤنڈ', lat: 31.5120, lng: 74.3790, district: 'Lahore', type: 'commercial', safetyScore: 93, wellLitPercent: 93, cctvPercent: 87, policeNearby: true, activeWomenCount: 6, safeZonesCount: 4 },
  { id: 'garhi-shahu', name: 'Garhi Shahu Junction', nameUrdu: 'گڑھی شاہو چوک', lat: 31.5640, lng: 74.3540, district: 'Lahore', type: 'transit', safetyScore: 80, wellLitPercent: 77, cctvPercent: 68, policeNearby: true, activeWomenCount: 4, safeZonesCount: 2 },
  { id: 'lake-city', name: 'Lake City Raiwind Road', nameUrdu: 'لیک سٹی رائے ونڈ روڈ', lat: 31.3680, lng: 74.2510, district: 'Lahore', type: 'residential', safetyScore: 92, wellLitPercent: 93, cctvPercent: 86, policeNearby: false, activeWomenCount: 3, safeZonesCount: 3 },
];
